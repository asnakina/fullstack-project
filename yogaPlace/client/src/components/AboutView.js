    ...
    <div className="aboutTextContent">
      <h2 className="mediumHeader">About us:</h2>
        <div className="aboutText">
           <ul>
              <li>The most productive 3 and 2 yoga-classes, where you definatly will spend more time on excersises than on your commite. We value your time, making it productive!</li>
